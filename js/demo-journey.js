/* Template Factory - Shorts Construction live demo journey.
...
(function () {
  ...
  var LIVE_URL = 'https://bottomlineventuresinc-hue.github.io/tf-demo-shorts-corona/';
  var LS_CHANGES = 'tf_shorts_change_log_v1';
  var LS_PURCHASED = 'tf_shorts_purchased_v1';
      ...
      apply: function () {
        if (heroLede) {
          heroLede.textContent =
            'Kitchen remodel, bathroom remodel, renovations, and general building across Corona and Riverside County. You get a fixed itemised quote before we start, Gerald as your named lead on site, and a twelve-month workmanship guarantee when we leave.';
        }
      }
    },
    {
  ...
  function setBarMode(mode) {
    ...
    if (!barSub) return;
    if (mode === 'updated') {
      barSub.textContent = 'Draft for Gerald at Shorts Construction. Claim it, preview the rest of the journey, or request a change.';
    } else {
      barSub.textContent = 'Draft for Gerald at Shorts Construction. Claim it, preview the rest of the journey, or request a change.';
    }
  }
  ...
  if (changeForm) {
    changeForm.addEventListener('submit', function (e) {
      ...
      runSpinner(
        ...
        'Updating the draft for Shorts Construction. Hang tight.',
        delay,
        function () {
